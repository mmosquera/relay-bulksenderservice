...
namespace Relay.BulkSenderService.Reports
{
    ...
    {
        public FullDailyReportProcessor(ILog logger, IConfiguration configuration, ReportTypeConfiguration reportTypeConfiguration)
        ...
        {
            _logger.Debug($"Create full daily report for user {user.Name}.");
