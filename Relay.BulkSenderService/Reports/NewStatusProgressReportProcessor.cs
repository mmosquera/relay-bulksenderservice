...
namespace Relay.BulkSenderService.Reports
{
    public class NewStatusProgressReportProcessor : ReportProcessor
    {
        ...
        public NewStatusProgressReportProcessor(ILog logger, IConfiguration configuration, ReportTypeConfiguration reportTypeConfiguration) : base(logger, configuration, reportTypeConfiguration)
        {
